  ...
  <div class="p-4 max-w-3xl mx-auto">
    ...
    <div v-else-if="leaderboard.length" class="space-y-4">
      ...
      <div 
        ...
        :key="user.id"
        class="bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-sm border border-gray-100 dark:border-gray-700 flex items-center space-x-4"
      >
        <!-- Rank -->
        ...
        <div class="flex items-center flex-1">
          ...
          <div 
            v-else
            class="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-lg font-bold text-blue-600 dark:text-blue-300"
          >
            {{ user.name.charAt(0).toUpperCase() }}
          </div>
          <div class="ml-3">
            <div class="font-medium text-gray-900 dark:text-gray-100">{{ user.name }}</div>
            <div class="text-sm text-gray-500 dark:text-gray-400">{{ user.totalDays }} days logged</div>
          </div>
        </div>
        ...
        <div class="flex items-center space-x-4">
          ...
          <div class="text-center">
            ...
            <div class="text-xs text-gray-500 dark:text-gray-400">Exercises</div>
          </div>
          <div class="text-center">
