...
<template>
    <div class="p-4 max-w-3xl mx-auto">
        ...
        <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100 text-center pb-6">Activity History</h1>
        

        <div v-if="loading" class="py-12 text-center">
            <div class="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 dark:border-blue-400 mx-auto">
            </div>
        </div>
        ...
        <div v-else-if="processedActivities" class="space-y-6">
            ...
            <div
                ...
                <div class="grid grid-cols-7 gap-2">
                    <template v-for="score in processedActivities.dailyScores" :key="score.date">
                        <button @click="navigateToDay(score.date)"
            ...
            <div
                ...
                <div class="space-y-4">
                    <!-- Deductions -->
                    <div>
                        <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Average Daily Deductions
                        </h4>
                        <div class="grid grid-cols-3 gap-4">
                            <div class="bg-red-50 dark:bg-red-900/20 rounded-xl p-3 text-center">
                                ...
                                <div class="font-bold text-red-600 dark:text-red-400">{{
                                    processedActivities.trends.badMeals }}
                                </div>
                            </div>
                            <div class="bg-red-50 dark:bg-red-900/20 rounded-xl p-3 text-center">
                                <div class="text-2xl mb-1">🍺</div>
                                ...
                                <div class="font-bold text-red-600 dark:text-red-400">{{
                                    processedActivities.trends.alcohol }}</div>
                            </div>
                            <div class="bg-red-50 dark:bg-red-900/20 rounded-xl p-3 text-center">
                                <div class="text-2xl mb-1">🍪</div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">Snacks</div>
                                <div class="font-bold text-red-600 dark:text-red-400">{{
                                    processedActivities.trends.snacks }}</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="bg-green-50 dark:bg-green-900/20 rounded-xl p-3 text-center">
                                ...
                                <div class="font-bold text-green-600 dark:text-green-400">{{
                                    processedActivities.trends.exercise }}%
                                </div>
                            </div>
                            <div class="bg-green-50 dark:bg-green-900/20 rounded-xl p-3 text-center">
                                <div class="text-2xl mb-1">🥬</div>
                                ...
                                <div class="font-bold text-green-600 dark:text-green-400">{{
                                    processedActivities.trends.greens }}%
                                </div>
                            </div>
                        </div>
                    </div>
